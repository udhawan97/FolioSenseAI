...
| Scrolling feels laggy or sluggish | Update to **v4.3.1 or newer** — it adds a lighter rendering profile for the desktop app and removes the main scroll-jank sources. [Get the latest release](https://github.com/udhawan97/FolioSenseAI/releases/latest) |
